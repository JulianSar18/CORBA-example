...
public class _CalculatorStub extends org.omg.CORBA.portable.ObjectImpl implements CalculatorApp.Calculator
{
  ...
  public String calcMonthlyFee (double purchase, double MonthlyFee)
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("calcMonthlyFee", true);
                $out.write_double (purchase);
                $out.write_double (MonthlyFee);
                $in = _invoke ($out);
                ...
                return calcMonthlyFee (purchase, MonthlyFee        );
            } finally {
                _releaseReply ($in);
            }
  } // calcMonthlyFee
