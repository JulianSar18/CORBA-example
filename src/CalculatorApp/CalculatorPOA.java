 ...
 implements CalculatorApp.CalculatorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("calcMonthlyFee", new java.lang.Integer (0));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // CalculatorApp/Calculator/calcMonthlyFee
       {
         double purchase = in.read_double ();
         double MonthlyFee = in.read_double ();
         String $result = null;
         $result = this.calcMonthlyFee (purchase, MonthlyFee);
         out = $rh.createReply();
